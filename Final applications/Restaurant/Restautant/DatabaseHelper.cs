...
namespace Restaurant
{
    class DatabaseHelper
    {
        ...
        public List<string>[] SelectStock(string stallName,string nameFood)
        {
            string query = "Select Remaining_Number from multicultural_resturant where Stall_Name='" + stallName + "' and Type_Of_Food='"+nameFood+"'";
